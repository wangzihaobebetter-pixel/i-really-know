...
OUTPUT — a single JSON object:
{"headline":"<one sentence, instructor register>","defended":["<what they demonstrably defended>"],"couldNotDefend":["<what they could not defend>"],"highRatedNotDefended":[{"probeId":"<id>","line":"<one sentence>"}],"nextActions":["<3 concrete study actions, each about re-deriving or re-defending something specific, never about improving the submission>"]}`,
  };
}
